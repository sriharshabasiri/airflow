...
scriptfile = " /Users/sriharshabasiri/airflow/finaclescript1.sh "
#if os.path.exists(scriptfile):
task0 = BashOperator(task_id= 'task0_finaclescript1',
...
task1= EmailOperator(
       ...
       subject='Airflow Alert Mail',
       html_content=""" <a href='https://www.freecodecamp.org/'><button>Yes</button></a> """,
       dag=dag
)
